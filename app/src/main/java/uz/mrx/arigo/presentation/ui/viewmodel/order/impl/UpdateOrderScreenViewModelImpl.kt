...
@HiltViewModel
class UpdateOrderScreenViewModelImpl @Inject constructor(private val useCase: OrderUseCase, private val direction:UpdateOrderScreenDirection):UpdateOrderScreenViewModel, ViewModel(){
