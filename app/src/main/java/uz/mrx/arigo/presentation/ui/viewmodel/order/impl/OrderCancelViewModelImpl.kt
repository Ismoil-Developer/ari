...
@HiltViewModel
class OrderCancelViewModelImpl  @Inject constructor(private val useCase: OrderUseCase, private val direction: OrderCancelScreenDirection):OrderCancelViewModel, ViewModel(){
